...
module.exports =
    {
        ...
        "EJA Alfa": [
            {componente="EJA Alfa", tipo:'c', nome: "Linguagem Oral e Escrita", ha: 2, cod: "ejaa"},
            {componente="EJA Alfa", tipo:'c', nome: "Matemática", ha: 2, cod: "ejaa"},
            {componente="EJA Alfa", tipo:'c', nome: "Estudo da Sociedade e da Natureza", ha: 2, cod: "ejaa"},
            {componente="EJA Alfa", tipo:'c', nome: "Artes", ha: 2, cod: "ejaa"},
            {componente="EJA Alfa", tipo:'c', nome: "Educação Física", ha: 2, cod: "ejaa"},
            {componente="EJA Alfa", tipo:'c', nome: "Ensino Religioso", ha: 2, cod: "ejaa"},
        ]
    }